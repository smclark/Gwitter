...
class PreferencesGwitterDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesGwitterDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesGwitterDialog object.
        """
        builder = get_builder('PreferencesGwitterDialog')
        new_object = builder.get_object("preferences_gwitter_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesGwitterDialog object with it in order to
        finish initializing the start of the new PerferencesGwitterDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesGwitterDialog()
    dialog.show()
    gtk.main()
